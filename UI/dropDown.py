...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 864, 835))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"background-color: rgb(225, 160, 103);")
        ...
        self.comboBox = QtWidgets.QComboBox(self.FirstScreen)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.comboBox.setItemText(0, _translate("mainWindow", "All Items"))
        self.comboBox.setItemText(1, _translate("mainWindow", "For your skin type"))
import Assets_rc
